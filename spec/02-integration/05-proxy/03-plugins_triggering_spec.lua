...
describe("Plugins triggering", function()
  ...
  describe("short-circuited requests", function()
    ...
    it("do not execute a header_filter plugin", function()
      local res = assert(client:send {
        method = "GET",
        path = "/status/200",
        headers = {
      ...
      -- TEST: ensure that the dummy plugin was not executed by checking
      -- that no headers have been injected in the header_filter phase
